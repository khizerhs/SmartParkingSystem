...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void addIDsToAutoComplete(List<String> emailAddressCollection) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            String url = getString(R.string.server_api_root) + getString(R.string.server_api_admin_authenticate);
            ...
            jsonObjectHelper.add(getString(R.string.log_in_user_name), mID);
            jsonObjectHelper.add(getString(R.string.log_in_user_password), mPassword);

            int returnCode = connectionHelper.request_Output(jsonObjectHelper.getResult());
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                //Send result RESULT_OK to MainActivity
                Intent returnIntent = new Intent();
                returnIntent.putExtra(getString(R.string.intent_result_name_admin_id), mID);
